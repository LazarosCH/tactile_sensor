...
class MinimalSubscriber(Node):
    def __init__(self):
        ...
        self.buffer = []
        self.model = keras.models.load_model(f"/home/lazaros/Desktop/rwr/TaskX/Models/POSITION/model_position.keras")
        self.x_scaler = joblib.load(f"/home/lazaros/Desktop/rwr/TaskX/Models/POSITION/x_scaler_position.save")
